...
def main() -> None:
    ...
    out_png = args.out_dir / "s4_cli_timeseries.png"
    out_pdf = args.out_dir / "s4_cli_timeseries.pdf"
    plot_figure(low, high, out_png, out_pdf, width_mm=args.width_mm, height_mm=args.height_mm)
